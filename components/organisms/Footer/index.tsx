        ...
        <div className="container-fluid">
            <div className="row">
                <div className="col-lg-4 text-lg-start text-center">
                    ...
                    <p className="mt-30 text-lg color-palette-1 mb-30">Gamesku membantu gamers<br/> untuk menjadi
                        pemenang sejati</p>
                            ...
                            <ul className="list-unstyled">
                                <li className="mb-6">
                                    <a href="mailto: hi@store.gg"
                                        className="text-lg color-palette-1 text-decoration-none">hi@gamesku.id</a>
                                </li>
                                <li className="mb-6">
                                    <a href="mailto: team@store.gg"
                                        className="text-lg color-palette-1 text-decoration-none">team@gamesku.id</a>
                                </li>
                                <li className="mb-6">
